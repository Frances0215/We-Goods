...
public class Fg1_Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fg1_3);
        Button btgood1=(Button)findViewById(R.id.bt_trouser1);
        Button btgood2=(Button)findViewById(R.id.bt_trouser2);
        Button btgood3=(Button)findViewById(R.id.bt_trouser3);
        Button btgood4=(Button)findViewById(R.id.bt_trouser4);
        ...
        btquit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Fg1_Activity3.this, Activity_Main.class);
        ...
        btgood1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent();
                intent.setClass(Fg1_Activity3.this,Fg2_Activity3.class);
                startActivity(intent);
            }
        });
        btadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent();
                intent.setClass(Fg1_Activity3.this,Fg1_ActivityAdd.class);
